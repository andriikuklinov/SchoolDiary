    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassPeriod_Id", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    YearName = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    StartDate = table.Column<DateOnly>(type: "date", nullable: true),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SchoolYear_Id", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrolnmentDate = table.Column<DateOnly>(type: "date", nullable: true, defaultValueSql: "(getdate())"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Class_ClassPeriodId",
                        column: x => x.ClassPeriodId,
                        principalTable: "ClassPeriod",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Class_ClassRoomId",
                        column: x => x.ClassRoomId,
                        principalTable: "ClassRoom",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Class_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Group",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Class_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScoreDate = table.Column<DateOnly>(type: "date", nullable: true),
                    ClassId = table.Column<int>(type: "int", nullable: false),
                    StudentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassScore_Id", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassScore_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Class",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClassScore_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassScore_ClassId",
                table: "ClassScore",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassScore_StudentId",
                table: "ClassScore",
                column: "StudentId");
